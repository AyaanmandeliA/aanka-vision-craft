...
export function CtaBlock({ eyebrow, heading, body, buttonLabel, to, tagline }: CtaBlockProps) {
  return (
      ...
      <div className="mx-auto max-w-[1440px] px-6 py-28 md:px-12 md:py-40">
        {eyebrow ? (
          <div className="mb-16 flex items-center gap-6 md:mb-20">
            ...
            <PulseLine className="h-4 flex-1 opacity-40" />
          </div>
        ) : null}
        ...
        <div className="grid grid-cols-12 gap-x-6 gap-y-16 md:gap-y-20">
          ...
          <div className="reveal col-span-12 lg:col-span-7">
            <h2 className="font-serif text-5xl font-light leading-[1.06] tracking-tight text-alabaster md:text-6xl lg:text-7xl">
              {heading}
            </h2>
          </div>
          ...
          {/* Body + CTA */}
          <div
            className="reveal col-span-12 flex flex-col justify-end lg:col-span-4 lg:col-start-9"
            style={{ transitionDelay: "120ms" }}
          >
            <p className="font-serif text-lg font-light leading-relaxed text-alabaster/65 md:text-xl">
              {body}
            </p>
            <Link
              to={to}
              className="group mt-10 inline-flex w-fit items-center gap-5 border border-alabaster/20 px-8 py-4 font-sans text-[11px] uppercase tracking-luxury text-alabaster transition-all duration-500 hover:border-bronze hover:bg-bronze hover:text-alabaster"
            >
              {buttonLabel}
              <span className="block h-px w-6 bg-alabaster/60 transition-all duration-500 group-hover:w-10 group-hover:bg-alabaster" />
            </Link>
          </div>

          {/* Tagline */}
          {tagline ? (
            <div className="reveal col-span-12 border-t border-alabaster/10 pt-14 md:pt-16" style={{ transitionDelay: "200ms" }}>
              <p className="font-serif text-3xl font-light italic leading-snug text-bronze/80 md:text-4xl lg:text-5xl">
                {tagline}
              </p>
            </div>
          ) : null}
