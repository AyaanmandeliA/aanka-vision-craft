...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    longDesc:
      "Aanka Constructions delivers commercial and residential projects across the UAE with a focus on dependable execution, structural quality, and long-term value. Quietly rigorous, transparently managed.",
    img: constImg,
    gallery: [constImg],
